...
<body>
	<section class="layerpop_wrap"><!--z-index: 300;-->
		...
		<article class="layerpop" style="width:359px; height:; left: 50%; top: 150px; margin:0 0 0 -160px;"><!--z-index: 600;-->
			...
			<section class="layerpop_body">
				<div class="layerpop_body_padding type1">
					<article class="layerpop_body_category_add">
						<div class="category_add_tit">
							<span class="icon_category">
								<span class="book"><img src="/healthcare/images/book/book_a_s.png" alt=""></span>
								<span class="icon"><img src="/healthcare/images/book/book_ic_1_s.png" alt=""></span>
							</span>
							<input type="text" placeholder="New Category" />
						</div>
						<div class="category_add_iconlist">
							<p><span class="ellipsis">Book image</span> </p>
							<ul>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_a_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_b_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_c_s.png" alt=""></span></span></li>
								<li><span class="icon_category on"><span class="book"><img src="/healthcare/images/book/book_d_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_e_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_f_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_g_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_h_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="book"><img src="/healthcare/images/book/book_i_s.png" alt=""></span></span></li>
							</ul>
						</div>
						<div class="category_add_iconlist zoom">
							<p><span class="ellipsis">Icon</span> </p>
							<ul>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_1_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_2_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_3_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_4_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_5_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_6_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_7_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_8_s.png" alt=""></span></span></li>
								<li><span class="icon_category"><span class="icon"><img src="/healthcare/images/book/book_ic_9_s.png" alt=""></span></span></li>
							</ul>
						</div>
					</article>
					...
					<div class="contents_padding">
						<article class="contents_top">
							<div class="contents_top_left">
								<h2 class="contents_title">Contents Management</h2>
							</div>
