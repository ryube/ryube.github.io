					...
					<div class="contents_padding">
						<article class="contents_top">
							<div class="contents_top_left">
								<h2 class="contents_title"><em>Notice</em></h2>
							</div>
									...
									<div class="layout_list_mid_scroll_wrapper">
										<div class="list_type1 right_padding">
											<table>
												<colgroup>
													<col class="col_chk">
													<col class="col_patientnotice_no">
													<col class="col_patientnotice_category">
													<col class="col_patientnotice_title">
													<col class="col_patientnotice_name">
													<col class="col_patientnotice_state">				
												</colgroup>
												<thead>
													<tr>
														<th class="td_chk"><input type="checkbox" /></th>
														<th><span class="ellipsis">No</span></th>
														<th class="th_sort">
															<div class="sort_wrap">
												...
												<table>
													...
													<tbody>
														<tr>
															...
															<td><span class="ellipsis">2012-01-01 01:30:30</span></td>
														</tr>
														<tr>
															<td class="td_chk"><input type="checkbox" /></td>
															<td><span class="ellipsis">1</span></td>
