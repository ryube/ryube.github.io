...
<body>
	<section class="layerpop_wrap"><!--z-index: 300;-->
		...
		<article class="layerpop" style="width:500px; height: 300px; left: 50%; top: 50%; margin:-150px 0 0 -250px;"><!--z-index: 600;-->
			...
			<section class="layerpop_body" id="d_scroll"style="height: 300px;">
			...
			var s1 = document.getElementById('d_scroll')
			console.log(s1.offsetHeight)
			console.log(s1.clientHeight)
			console.log(s1.scrollHeight)
											var test111 = fakescroll.set('d_scroll');
											test111.scrollHeight(100);
										</script>
										<button onclick="
										    if(test111){
										    	test111 = test111.remove();
										    }
										">remove</button>
							...
							<div class="contents_option_right">
								<div class="contents_option_right_display">
									...
									<span class="btn_view_ch">
										<a id="layout_none" class="btn"><span>normal</span></a><a id="layout_vertical" class="btn"><span>vertical</span></a><a id="layout_horizontal" class="btn"><span>horizen</span></a>
									</span>
									<span class="btn_detail_pagemove"><a href="#" class="pagemove_prev"><span>Prev</span></a><a href="#" class="pagemove_next"><span>Next</span></a></span>
