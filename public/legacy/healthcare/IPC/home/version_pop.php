		...
		<article class="layerpop" style="width:320px; height:; left: 50%; top: 150px; margin:0 0 0 -160px;"><!--z-index: 600;-->
			...
			<section class="layerpop_body">
				<div class="layerpop_body_padding type1">
					<article class="layerpop_version">
						<div class="version_tit">
							<span class="logo"><img src="/healthcare/images/logo_icon.png" alt="IPC logo"></span>
							<p class="tit"><strong>Samsung IPC Admin</strong></p>
							<p class="ver">Version 1.0.0</p>
						</div>
						<p class="copyright">Copyright &copy;2012 Samsung Electronics Co., Ltd. All rights reserved.</p>
					</article>
					<div class="layerpop_body_bottom_btn">
				 		<button href="#" class="btn"><span>확인</span></button>
				 	</div>
				</div>			 	
			</section>
