...
<body>
	<section class="layerpop_wrap"><!--z-index: 300;-->
		...
		<article class="layerpop" style="width:690px; height:; left: 50%; top: 50%; margin:-227px 0 0 -345px;"><!--z-index: 600;-->
								...
								<table>
									...
									<thead>
										<tr>
											...
											<th class="th_sort">
												<div class="sort_wrap">
													<span class="ellipsis">Building</span>
											...
											<th class="th_sort">
												<div class="sort_wrap">
													<span class="ellipsis">Floor</span>
													<div class="filter_opt">
														<span class="filter_ico"></span>
														<div class="flter_opt_layer">
															<ul class="flter_opt_layer_chklist">
											...
											<th><span class="ellipsis">Room Number</span></th>
											<th class="th_last"><span class="ellipsis">Bed ID</span></th>
										</tr>
									</thead>
								</table>
							</div>
					...
					<div class="contents_padding">
						<article class="contents_top">
							<div class="contents_top_left">
								<h2 class="contents_title"><em>Patient Management</em></h2>
							</div>
						...
						<article class="contents_option">
							<div class="contents_option_left">
								<span class="contents_option_left_bundle">
									<a href="#" class="btn"><span><span class="ellipsis">Mapping</span></span></a>
									<a href="#" class="btn"><span><span class="ellipsis">Clear</span></span></a>
								</span>
								<span class="contents_option_left_bundle">
									<a href="#" class="btn"><span>Bed Change</span></a>
								</span>
								<span class="contents_option_left_bundle">
									...
									<div class="layout_list_mid_scroll_wrapper">
										<div class="list_type1 right_padding">
											<table>
												<colgroup>
													<col class="col_chk">
													<col class="col_patient_manage_buliding">
													<col class="col_patient_manage_floor">
													<col class="col_patient_manage_ward">
													<col class="col_patient_manage_room">
													<col class="col_patient_manage_bedid">
													<col class="col_patient_manage_patientid">
													<col class="col_patient_manage_name">								
													<col class="col_patient_manage_birth">								
												</colgroup>
												<thead>
													<tr>
														<th class="td_chk"><input type="checkbox" /></th>
														...
														<th class="th_last"><span class="ellipsis">Birthdate</span></th>
													</tr>
												</thead>
											</table>
										</div>
												...
												<table>
													...
													<tbody>
														<tr>
															...
															<td><span class="ellipsis">103</span></td>
															<td><span class="ellipsis">AABBCC1234</span></td>
															<td><span class="ellipsis txt_not">Not Mapped</span></td>
															<td><span class="ellipsis txt_not">Not Mapped</span></td>
															<td><span class="ellipsis txt_not">Not Mapped</span></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td><span class="ellipsis">1998.09.27</span></td>
														</tr>
														<tr>
															<td class="td_chk"><input type="checkbox" /></td>
															<td><span class="ellipsis">A</span></td>
