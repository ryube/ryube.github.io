					...
					<div class="contents_padding">
						<article class="contents_top">
							<div class="contents_top_left">
								<h2 class="contents_title">History<span class="contents_title_arrow"></span><em>Emergency Access</em></h2>
							</div>
						...
						<article class="contents_option">
							<div class="contents_option_left">
								<div class="contents_option_left_period">
									...
									<span class="date_pick_wrap"><span href="#" class="btn_date_pick"></span><input type="text" id="startDate" name="startDate" value="2012-03-06"></span>
									<span class="contents_option_left_period_txt">~</span>
									<span class="date_pick_wrap"><span href="#" class="btn_date_pick"></span><input type="text" id="endDate" value="2012-04-06"></span>
