...
<body>
	...
	<section class="layer_header_filter" style="left: 500px; top: 200px; display:block;">
		<div class="header_filter">
			<div class="group_tree">
				<ul id="sortable">
					<li class="on"><span class="sort-handle"></span><div><input type="checkbox" ><span class="group_tree_item">GS1</span></div></li>
					<li class="disable"><span class="sort-handle"></span><div><input type="checkbox" disabled><span class="group_tree_item">GS1</span></div></li>
					<li><span class="sort-handle"></span><div><input type="checkbox"><span class="group_tree_item">GS1</span></div></li>
					<li><span class="sort-handle"></span><div><input type="checkbox"><span class="group_tree_item">GS1</span></div></li>
					<li><span class="sort-handle"></span><div><input type="checkbox"><span class="group_tree_item">GS1</span></div></li>
					<li><span class="sort-handle"></span><div><input type="checkbox"><span class="group_tree_item">GS1</span></div></li>
					<li><span class="sort-handle"></span><div><input type="checkbox"><span class="group_tree_item">GS1</span></div></li>
			...
			<div class="header_filter_button">
				<a href="#" class="btn blue"><span>Default</span></a>
								...
								<div class="search_wrap">
									<div class="combobox">
										...
										<span class="label_holder">
											<label for="search_text">Searh</label>
											<input id="search_text" type="text" placeholder="" />
										</span>
										<div class="search_suggest">
											<ul id="testul">
												<li><a href="#"><span class="ellipsis">1</span></a></li>
												<li><a href="#"><span class="ellipsis">2</span></a></li>
												<li><a href="#"><span class="ellipsis">3</span></a></li>
												<li id="testli"><a href="#"><span class="ellipsis">4</span></a></li>
												<li><a href="#"><span class="ellipsis">5</span></a></li>
												<li><a href="#"><span class="ellipsis">6</span></a></li>
												<li><a href="#"><span class="ellipsis">7</span></a></li>
