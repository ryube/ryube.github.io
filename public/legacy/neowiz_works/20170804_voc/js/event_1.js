...
function scrollMove() {
  $(".btn_pos")
    ...
    .on("click", function () {
      ...
      $("html, body")
        .stop(true, false)
        .animate({ scrollTop: desOffset.top }, 2000, "easeInOutQuint");
      return false;
    });
}
...
function layerBtn() {
  ...
  function closeAni() {
    $(".layer_pop.on")
      .stop(true, false)
      .animate({ opacity: 0, marginTop: 25 }, 250, "easeInQuad", function () {
        $(this).attr("style", "").removeClass("on ani-on");
      });
    $(".pop_dim")
      .stop(true, false)
      .animate({ opacity: 0 }, 250, "easeInQuad", function () {
  ...
  function openAni(t) {
    $(t)
      .addClass("on")
      .stop(true, false)
      .animate({ opacity: 1, marginTop: 0 }, 250, "easeOutQuad", function () {
        $(this).addClass("ani-on");
      });
    $(".pop_dim")
      .addClass("on")
      .stop(true, false)
      .animate({ opacity: 0.9 }, 250, "easeOutQuad", function () {});
    //docScrollBlock(true);
  }
  $(".btn_layer")
    .off("click.layerpop")
    .on("click.layerpop", function () {
      ...
      if ($(target).attr("yt-code")) {
        ...
        videoSource =
          ...
          vCode +
          '?feature=player_detailpage&wmode=opaque" frameborder="0" allowfullscreen>';
...
var docScrollBlock = function (off) {
  off
    ? $(document).on("mousewheel.block DOMMouseScroll.block", function (e) {
        e.stopPropagation();
        e.preventDefault();
      })
