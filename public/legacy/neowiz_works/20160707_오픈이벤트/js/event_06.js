...
function layerBtn2() {
	function closeAni(){
		$('.layer_mov, .layer_pop.on').stop(true, false).animate({ opacity: 0, marginTop: 25}, 250, 'easeInQuad',function(){$(this).attr('style','').removeClass('on')});
	...
	$('.btn_mov, .btn_layer2.on').off().on('click', function(){
...
//document Ready
$(function(){
  $('.layer_pop a').on('click', function(){return false;});
	reloadUi();
