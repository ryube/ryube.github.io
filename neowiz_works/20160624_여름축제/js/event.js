...
$(function(){
	...
	var gOff = $gnbEl.offset();
	if($gnbEl.length != 0){
		$(window).bind('scroll',function(){
			wt = $(this).scrollTop();
			$('.scroll_value').text(wt);

			gOff.top<wt?$gnbEl.addClass('fixed'):$gnbEl.removeClass('fixed');
			wt>200?$gnbEl.addClass('h1-off'):$gnbEl.removeClass('h1-off');
			

			if(wt>7100){
				$qck.attr('class', 'qck e3');
				$gnbEl.removeClass('h2-en h2-kr').addClass('h2-kr');
			} else if (wt>4200) {
				$qck.attr('class', 'qck e2');
				$gnbEl.removeClass('h2-en h2-kr').addClass('h2-en');
			} else if (wt>1500) {
				$qck.attr('class', 'qck e1');
				$gnbEl.removeClass('h2-en h2-kr').addClass('h2-kr');
			} else {
				$qck.attr('class', 'qck e0');
				$gnbEl.removeClass('h2-en h2-kr').addClass('h2-en');
			}
	...
	$('.dept1>li.l1').on({
		mouseenter : function(){
			$gnbEl.addClass('hover');
		},
		mouseleave : function() {
			$gnbEl.removeClass('hover');
