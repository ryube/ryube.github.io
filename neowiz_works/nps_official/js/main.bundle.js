(function ($) {
  ...
  function listOpen() {
    ...
    function boxClone(s) {
      vars.$html.append(
        $__default["default"](s).find(".responsive__box-clone").clone()
      );
      setTimeout(function () {
        vars.$html
          .find(".responsive__box-clone:not(.state--before)")
  ...
  var pcPaticle = function () {
    ...
    if (!(msie < 10)) {
      particlesJS.load(
        "dot-particles",
        "https://ryube.github.io/neowiz_works/nps_official/particles/dot.json",
        function () {
          $__default["default"](".particles,.sub__particles").addClass(
            "loaded"
          );
        }
      );
      particlesJS.load(
        "line-particles",
        "https://ryube.github.io/neowiz_works/nps_official/particles/rain.json",
        function () {
  ...
  var mobilePaticle = function () {
    if (!$__default["default"]("html").hasClass("ie-legacy")) {
      particlesJS.load(
        "dot-particles",
        "https://ryube.github.io/neowiz_works/nps_official/particles/dot-m.json",
        function () {
          $__default["default"](".particles,.sub__particles").addClass(
            "loaded"
          );
      ...
      particlesJS.load(
        "line-particles",
        "https://ryube.github.io/neowiz_works/nps_official/particles/rain-m.json",
        function () {}
      );
    } else {
      $__default["default"](".bg--replace").addClass("add--bg");
