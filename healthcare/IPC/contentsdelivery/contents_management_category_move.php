...
<body>
	<section class="layerpop_wrap"><!--z-index: 300;-->
					...
					<article class="layerpop_body_category">
						<div class="layerpop_body_category_topbtn">
						 	<span class="contents_option_left_bundle">
								<a href="#" class="btn"><span>Done</span></a>
							</span>
						 	<span class="contents_option_left_bundle">
		...
		<article class="layerpop" style="width:320px; height:; left: 50%; top: 150px; margin:0 0 0 -160px;"><!--z-index: 600;-->
			...
			<section class="layerpop_body">
				<div class="layerpop_body_padding type1">
					<article class="layerpop_body_category_move">
						<p class="layerpop_body_category_move_info">삭제할 카테고리에 등록되어 있는 Contents를 <br />다른 카테고리로 이동하겠습니까?</p>
						<div class="layerpop_body_category_move_select">
							<span class="category_move_radio"><input type="radio" id="layer_cate_del01"><label for="layer_cate_del01">다른 카테고리로 이동시킵니다.</label></span>
							<div class="category_move_combo_wrap">
								<div class="combobox">
						...
						<div class="layerpop_body_category_move_select">
							<span class="category_move_radio"><input type="radio" id="layer_cate_del02"><label for="layer_cate_del02">카테고리와 함께 모두 삭제합니다.</label></span>
						</div>
					</article>
					<div class="layerpop_body_bottom_btn">
				 		<a href="#" class="btn blue"><span>Done</span></a>
