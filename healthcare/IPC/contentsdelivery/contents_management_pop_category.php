					...
					<article class="layerpop_body_category">
						...
						<div class="layerpop_body_category_list_wrap">
							<div class="group_tree">
								<ul>
									<li><div><input type="checkbox"><span class="group_tree_item hide_cate"><span class="icon_category"><img src="/healthcare/images/thumb/thumb_default.png" alt=""></span>GS1<label for="cate_hide01" class="hide_chk">숨김<input type="checkbox" id="cate_hide01"></label></span></div></li>
									<li><div><input type="checkbox"><span class="group_tree_item hide_cate"><span class="icon_category"><img src="/healthcare/images/thumb/thumb_default.png" alt=""></span>GS1<label for="cate_hide02" class="hide_chk">숨김<input type="checkbox" id="cate_hide02"></label></span></div></li>
									<li><div><input type="checkbox"><span class="group_tree_item hide_cate"><span class="icon_category"><img src="/healthcare/images/thumb/thumb_default.png" alt=""></span>GS1<label for="cate_hide03" class="hide_chk">숨김<input type="checkbox" id="cate_hide03"></label></span></div></li>
									<li><div><input type="checkbox"><span class="group_tree_item hide_cate"><span class="icon_category"><img src="/healthcare/images/thumb/thumb_default.png" alt=""></span>GS1<label for="cate_hide04" class="hide_chk">숨김<input type="checkbox" id="cate_hide04"></label></span></div></li>
									<li><div><input type="checkbox"><span class="group_tree_item hide_cate">GS1</span></div></li>
